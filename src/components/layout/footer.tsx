...
export default function Footer() {
  return (
    <footer id="footer-contato" className="bg-muted text-muted-foreground py-12">
      <div className="container">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl font-headline font-semibold text-center text-foreground mb-6">Nossa Localização</h3>
          ...
          <div className="flex flex-col items-center text-center">
            <h3 className="text-2xl font-headline font-semibold text-foreground mb-4">Informações de Contato</h3>
      ...
      <div className="container text-center mt-12 pt-8 border-t">
        <p className="text-sm">&copy; {new Date().getFullYear()} CrediSoluções. Todos os direitos reservados.</p>
      </div>
    </footer>
  );
}
